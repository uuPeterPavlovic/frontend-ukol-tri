...
const Errors = require("../api/errors/frontend-main-error.js");
...
const logger = LoggerFactory.get("FrontendMainAbl");

class FrontendMainAbl {
  constructor() {
...
module.exports = new FrontendMainAbl();
